...
This repository separates five rights-bearing objects:
...
Their file headers and ledger rows control. Original Arcanea commentary and
composition remain governed by the repository licensing policy.
